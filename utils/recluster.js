...
const recluster = async (k = 3) => {
  ...
  //       {
  // centroid: [Number, Number, Number], // center of the cluster (normalized)
  // cluster: [Array of normalized points assigned to this cluster],
  // clusterInd: [Array of original indexes of the points in input array]
  //       } in each index of results
